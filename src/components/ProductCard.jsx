            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className='flex items-center gap-0.5'>
                    {Array(5).fill("").map((_,i)=>(
                        <img key={i} src={i<4?assets.star_icon:assets.star_dull_icon} className='w-3 md:w-3.5'/>
                    ))
                    }
                    <p>(4)</p>
                </div>
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-indigo-500" onClick={(e)=>e.stopPropagation()}>
                        {count === 0 ? (
                            <button className="cursor-pointer flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-[80px] w-[64px] h-[34px] rounded text-indigo-600 font-medium" onClick={() => setCount(1)} >
